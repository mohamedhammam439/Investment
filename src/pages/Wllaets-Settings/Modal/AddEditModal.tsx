...
const AddEditModal: React.FC<AddEditModalProps> = ({
  ...
  const { useCreate, useUpdateWithParams , useUpdate} = createCrudService<any>('setting-wallet')
  ...
  const title =
    modalType === 'Add' ? t('Add New Wallet Settings') : t('Edit Wallet Settings')
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder={t('Enter Reward')} {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder={t('Enter salary')} {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder={t('Enter target')} {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
